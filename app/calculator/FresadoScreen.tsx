...
export default function FresadoScreen({ navigation }) {
        ...
        AsyncStorage.multiGet([
            ...
            'fresado-ca'], (err, fresado) => {
                fresado.forEach(row => {
                    ...
                    } else if (row[0] == 'fresado-d') {
                        setTextD( row[1] == null? "0":row[1]);
                    } else if (row[0] == 'fresado-z') {
                        setTextZ( row[1] == null? "0":row[1]);
                    } else if (row[0] == 'fresado-n') {
                        setTextN( row[1] == null? "0":row[1]);
                    } else if (row[0] == 'fresado-vc') {
                        setTextVc( row[1] == null? "0":row[1]);
                    } else if (row[0] == 'fresado-fz') {
                        setTextfz( row[1] == null? "0":row[1]);
                    } else if (row[0] == 'fresado-fn') {
                        setTextfn( row[1] == null? "0":row[1]);
                    } else if (row[0] == 'fresado-vf') {
                        setTextvf( row[1] == null? "0":row[1]);
                    } else if (row[0] == 'fresado-tc') {
                        setTexttc( row[1] == null? "0":row[1]);
                    } else if (row[0] == 'fresado-q') {
                        setTextQ( row[1] == null? "0":row[1]);
                    } else if (row[0] == 'fresado-ap') {
                        setTextap( row[1] == null? "0":row[1]);
                    } else if (row[0] == 'fresado-ae') {
                        setTextae( row[1] == null? "0":row[1]);
                    } else if (row[0] == 'fresado-np') {
                        setTextnp( row[1] == null? "0":row[1]);
                    } else if (row[0] == 'fresado-lm') {
                        setTextlm( row[1] == null? "0":row[1]);
                    } else if (row[0] == 'fresado-ca') {
                        setTextoCa( row[1] == null? "0":row[1]);
                    }
    ...
    const calcButton = {
        ...
        padding:0,
        //backgroundColor:Constants.colores.textColor,
        alignItems:'center',
    ...
    function textClick(opcion, direccion){
        if(opcion != null){
            ...
            if(opcion_e == 2 || opcion_e == 3 || opcion_e == 4 || opcion_e == 7 || opcion_e == 10){
                setBPunto(true);
            }else{
                setBPunto(false);
            }
    ...
    function editarCampo(boton){
        ...
        switch(boton){
            ...
            case 'C':
                ...
                if(parseFloat(textoCampo) == 0 || isNaN(parseFloat(textoCampo)) ){
                    ...
                    AsyncStorage.setItem('fresado-d', '0');
                    AsyncStorage.setItem('fresado-z', '0');
                    AsyncStorage.setItem('fresado-n', '0');
                    AsyncStorage.setItem('fresado-vc', '0');
                    AsyncStorage.setItem('fresado-fz', '0');
                    AsyncStorage.setItem('fresado-fn', '0');
                    AsyncStorage.setItem('fresado-vf', '0');
                    AsyncStorage.setItem('fresado-tc', '0');
                    AsyncStorage.setItem('fresado-q', '0');
                    AsyncStorage.setItem('fresado-ap', '0');
                    AsyncStorage.setItem('fresado-ae', '0');
                    AsyncStorage.setItem('fresado-np', '0');
                    AsyncStorage.setItem('fresado-lm', '0');
                    AsyncStorage.setItem('fresado-ca', '0');
                }else{
                    textoCampo = '0';
                }
                break;
        ...
        switch(editable){
            case 1:
                ...
                var ap = parseFloat(textap);
                var ae = parseFloat(textae);
                var np = parseFloat(textnp);
                var lm = parseFloat(textlm);
        ...
        <View
            ...
            <ScrollView
                ...
                backgroundColor: Colors.white, flexDirection:'column'
                    ...
                    <ViewShot ref={refScreenshot} options={{ fileName: "Your-File-Name", format: "jpg", quality: 0.9, result:'base64' }} style={{backgroundColor: Colors.white,}}>
                        ...
                        onPress={text => {textClick(null,0)}}>
                            ...
                            <View
                                ...
                                <Text style={labelRow} >{t('fresado:d')}</Text>
                                <View 
                                    style={[editable == 1 ? inputContainerSelected : inputContainerIngresan]}>
                            ...
                            <View
                                ...
                                <Text style={labelRow} >{t('fresado:z')}</Text>
                            ...
                            <View
                                ...
                                <Text style={labelRow} >{t('fresado:n')}</Text>
                                <View style={[editable == 3 ? inputContainerSelected : inputContainerAmbos]}>
                                    <TouchableOpacity style={[textinputstyle]} onPress={text => {textClick(3, 0)}} >
                            ...
                            <View
                                ...
                                <Text style={labelRow} >{t('fresado:vc')}</Text>
                            ...
                            <View
                                ...
                                <Text style={labelRow} >{t('fresado:fz')}</Text>
                            ...
                            <View
                                ...
                                <Text style={labelRow} >{t('fresado:fn')}</Text>
                            ...
                            <View
                                ...
                                <Text style={labelRow} >{t('fresado:vf')}</Text>
                                <View style={[editable == 7 ? inputContainerSelected : inputContainerAmbos]}>
                                    <TouchableOpacity style={[textinputstyle]} onPress={text => {textClick(7,0)}} >
                            ...
                            <View
                                ...
                                <Text style={labelRow} >{t('fresado:ap')}</Text>
                                <View style={[editable == 8 ? inputContainerSelected : inputContainerIngresan]}>
                                    <TouchableOpacity style={textinputstyle} onPress={text => {textClick(8,0)}} >
                                        <Text style={labelInputText} >{textap}</Text>
                                    </TouchableOpacity>
                                </View>
                                <Text style={labelMedRow} >{medidas['mm']}</Text>
                            </View>
                            <View
                                ...
                                <Text style={labelRow} >{t('fresado:ae')}</Text>
                                <View style={[editable == 9 ? inputContainerSelected : inputContainerIngresan]}>
                                    <TouchableOpacity style={textinputstyle} onPress={text => {textClick(9,0)}} >
                                        <Text style={labelInputText} >{textae}</Text>
                                    </TouchableOpacity>
                                </View>
                                <Text style={labelMedRow} >{medidas['mm']}</Text>
                            </View>
                            <View
                                ...
                                <Text style={labelRow} >{t('fresado:np')}</Text>
                                <View style={[editable == 10 ? inputContainerSelected : inputContainerIngresan]}>
                                    <TouchableOpacity style={textinputstyle} onPress={text => {textClick(10,0)}} >
                                        <Text style={labelInputText} >{textnp}</Text>
                                    </TouchableOpacity>
                                </View>
                                <Text style={labelMedRow} ></Text>
                            </View>
                            <View
                                ...
                                <Text style={labelRow} >{t('fresado:lm')}</Text>
                                <View 
                                    style={[editable == 11 ? inputContainerSelected : inputContainerIngresan]}>
                                    <TouchableOpacity style={textinputstyle} onPress={text => {textClick(11,0)}} >
                                        <Text style={labelInputText} >{textlm}</Text>
                                    </TouchableOpacity>
                                </View>
                                <Text style={labelMedRow} >{medidas['mm']}</Text>
                            </View>
                            <View
                                ...
                                <Text style={labelRow} >{t('fresado:tc')}</Text>
                            ...
                            <View
                                ...
                                <Text style={labelRow} >{t('fresado:q')}</Text>
